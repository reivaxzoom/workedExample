...
public class QueryProcessor {
    ...
    private static final String reqTopicName = "requestTopic";
    private static final String JMSselector = "category='computer' OR category='software' OR category='hardware'  ";
    private static final String topicName = "bestBuy";
    ...
    public void consumeAll() {
        ...
        try {
            ...
            Topic requestTopic = session.createTopic(reqTopicName);
...
//            Destination queue = new AMQAnyDestination("responseQueue");
            ...
            m.setStringProperty("name", "Best buy");
            m.setStringProperty("addres", "technology center utca");
